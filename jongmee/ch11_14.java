...
static void inputRecord() {
  ...
  while(true) {
    System.out.print(">>");
    try{
      String scan = s.nextLine().trim();
      if(!scan.equalsIgnoreCase("q")){
        return;
      } else {
        Scanner scan2 = new Scanner(scan).useDelimiter(",");
        Student student = new Student(scan2.next(), scan2.nextInt(), scan2.nextInt(), scan2.nextInt(), scan2.nextInt(), scan2.nextInt());
        record.add(student);
